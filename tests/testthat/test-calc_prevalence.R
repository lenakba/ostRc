...
d_ostrc = tibble(id_particpant, ~day_nr, ~hp,
                 1, 1, 1,
                 1, 1, 0,
                 1, 1, 0,
                 1, 2, 0,
...
test_that("Returns correct number of cases
          (a response of 1 on an health problem variable is a case).", {
  n_cases = c(1, 1)
  d_test = calc_prevalence(d_ostrc$id_particpant, d_ostrc$day_nr, d_ostrc$hp)
