...
and returns a dataframe where each entry corresponds to each health problem.
The function also finds and adds the startdate, enddate, 
and the duration (in days) of each health problem to the returned dataframe.
It also identifies substantial health problems and adds a column for these.
